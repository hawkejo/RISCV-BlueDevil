...
REM
REM Generated by Vivado on Tue Apr 29 17:54:41 -0400 2025
...
echo "xvlog --incr --relax -L uvm -prj rv64i_tb_top_vlog.prj"
call xvlog  --incr --relax -L uvm -prj rv64i_tb_top_vlog.prj -log xvlog.log
